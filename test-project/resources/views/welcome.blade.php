...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
            <h1 class="display-4">Join Our <span class="team">Team</span></h1>
...
<div class="jumbotron-subscribe jumbotron-fluid text-center">
  <div class="container subscribe text-center">
    ...
    <!-- <input type="text" class="form-control" placeholder="Enter Your Email Address" aria-label="Recipient's username" aria-describedby="basic-addon2" ><button type="button" class="btn btn-primary submit-btn">Primary</button> -->
  </div>
</div>   
